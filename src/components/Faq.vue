  ...
  <div>
    <div class="faq-main">
      <div class="columns">
        ...
        <div class="column is-half inline top-10 second">
          <div class="icons">
            <i class="fa-brands fa-reddit icon"></i>
          ...
          <div class="text is-flex">
            ...
            <div class="right">
              <h3>All Rights Reserved © monday.com</h3>
            </div>
          </div>
        </div>
        <div class="column inline">
          <div class="applications is-flex">
            <div class="playstore">
              <svg
                width="135"
                height="40"
...
<script>
import UpDropdown from "./UpDropdown.vue";
export default {
  name: "Faq-vue",
  components: { UpDropdown },
};
</script>
<style scoped>
.inline {
